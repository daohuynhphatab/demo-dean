...
class FacultyManagerFrame(ctk.CTkFrame):
    ...
    def load_faculties(self):
        ...
        try:
            ...
            cursor.execute("SELECT makhoa, tenkhoa, truongkhoa FROM khoa ORDER BY makhoa")
    ...
    def refresh_list(self):
        ...
        for f in self.faculties:
            self.tree.insert("", "end", values=(f["makhoa"], f["tenkhoa"], f["truongkhoa"]))
    ...
    def add_faculty(self):
        ...
        try:
            cursor = conn.cursor()
            cursor.execute("INSERT INTO khoa (makhoa, tenkhoa, truongkhoa) VALUES (%s, %s, %s)",
    ...
    def update_faculty(self):
        ...
        try:
            ...
            cursor.execute("UPDATE khoa SET tenkhoa=%s, truongkhoa=%s WHERE makhoa=%s",
                           (tenkhoa, truongkhoa, makhoa))
            conn.commit()
    ...
    def select_faculty(self, event=None):
        ...
        makhoa, tenkhoa, truongkhoa = values
